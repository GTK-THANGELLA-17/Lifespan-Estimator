      ...
      <DialogContent className="w-[90%] max-w-md rounded-lg p-4">
        <DialogHeader>
          ...
          <DialogDescription className="text-center text-xs">
            Behind the Lifespan Estimator application
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 pt-4">
          ...
          <div className="space-y-2 text-xs w-full sm:w-[60%]">
            <p>
              I build impactful digital tools to simplify complex systems. The Lifespan Estimator reflects my passion for health-tech innovation and accessible design.
            </p>
